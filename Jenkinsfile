    ...
    stages {
        stage('Create  directory for the WEB Application')
        {
            steps{
                ...
                sh 'rm -rf /home/mcherlo/docker/jenkins/app-web'
                //Create the directory
                sh 'mkdir /home/mcherlo/docker/jenkins/app-web'
        ...
        stage('Create the Apache container') {
            ...
            sh 'docker run -dit --name app-web -p 9100:80  -v /home/mcherlo/docker/jenkins/app-web:/usr/local/apache2/htdocs/ httpd'
            }
        }
        //Nginx webserver
        stage('Create the Nginx container') {
            ...
            steps {
            echo 'Creating the container...'
            sh 'docker run -dit --name app-web -p 9100:80  -v /home/mcherlo/docker/jenkins/app-web:/usr/share/nginx/html nginx'
        ...
        stage('Copy the web application to the container directory') {
            steps {
                ...
                sh 'cp -r web/* /home/mcherlo/docker/jenkins/app-web'
            }
        }
    }
